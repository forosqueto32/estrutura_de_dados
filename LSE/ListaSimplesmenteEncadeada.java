...
import LDE.Celula;
import LDE.Iterador;
import LDE.IteradorReverso;

public class ListaSimplesmenteEncadeada<Tipo> implements Lista<Tipo>{
	...
	public void adicionaNoInicio(Tipo elemento) {
		Celula nova = new Celula(this.primeira, elemento);//this.primeira aqui é igual a null
		this.primeira = nova;
	...
	public void removeDoFim() {
			  ...
			  Celula penultima = pegaCelula(totalElementos-2);
